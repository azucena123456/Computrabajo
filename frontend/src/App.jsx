        ...
        return (
            <div className="flex flex-col items-center justify-center py-10 text-center">
                ...
                <button
                    ...
                    className="mt-4 bg-transparent text-purple-600 border border-purple-600 font-bold py-2 px-6 rounded-full shadow-md hover:bg-purple-600 hover:text-white focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2 transition duration-300 transform hover:scale-105"
                    disabled={!loading}
                >
                    Cancelar Búsqueda
                </button>
